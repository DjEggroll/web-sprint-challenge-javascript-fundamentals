...
//nestedFunction exists within the same code block as the variable internal, allowing it to be accessed.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const lowerCaseAnimals = array.map((zooAnimal) => {
...
//   let results = [];
//   for(i in this){
//     const zooAnimal = this[i];
//     results.push(cb(zooAnimal))
//     // (zooAnimal) => {
//     //   return zooAnimal.animal_name.toLowerCase();    
//     // }
//   }
...
// }
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const filteredAnimals = array.filter((animal) => {
  ...
  */
  ...
  function USApop(array){
    const reducedAnimals = array.reduce((accu, curr) => {
